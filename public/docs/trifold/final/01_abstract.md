...
Overall, the primary contribution is a reproducible modeling workflow and teaching tool that demonstrates how this class of multi-layer problems can be approached correctly. Robust mechanistic inference would require larger paired datasets, confounder control, and more computing resources.
